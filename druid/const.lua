...
M.ACTION_UP = hash(sys.get_config("druid.input_key_up", "key_up"))
M.ACTION_DOWN = hash(sys.get_config("druid.input_key_down", "key_down"))
M.ACTION_CTRL = hash(sys.get_config("druid.input_key_lctrl", "key_lctrl"))
M.ACTION_KEY_V = hash(sys.get_config("druid.input_key_v", "key_v"))
