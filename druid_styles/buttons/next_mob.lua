...
M["button"] = {
	...
	on_hover = function(self, node, state)
        ...
        gui.play_flipbook(node, state and "gui_next_mob_push" or "gui_next_mob_default")
	end,
	...
	on_mouse_hover = function(self, node, state)
		...
		gui.play_flipbook(node, state and "gui_next_mob_cursor" or "gui_next_mob_default")
	end,
